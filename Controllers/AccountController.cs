...
namespace Project.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public ActionResult UserLogin(Customer customer)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        var authuser = db.Customers.FirstOrDefault(row => row.EmailID == customer.EmailID && row.Password == customer.Password);
        //        if (authuser != null)
        //        {
        //            Session["Role"] = authuser.EmailID;
        //            FormsAuthentication.SetAuthCookie(customer.EmailID, false);
       ...
       // GET: /Account/DriverLogin
       [AllowAnonymous]
            public ActionResult DriverLogin(string returnUrl)
            {
                ViewBag.ReturnUrl = returnUrl;
            ...
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> DriverLogin(DriverLoginViewModel model, string returnUrl)
            {
                if (!ModelState.IsValid)
                {
                    return View(model);
            ...
            //
            // POST: /Account/AdminReg
            [HttpPost]
            [AllowAnonymous]
            [ValidateAntiForgeryToken]
            public async Task<ActionResult> AdminReg(AdminRegViewModel model)
            {
                if (ModelState.IsValid)
                {
                    var user = new ApplicationUser { UserName = model.Email, Email = model.Email };
